defmodule Point.Services.MovementService do
  @moduledoc """
  Allow make operations with accounts like a:
    - transfer: Transfer an amount between two accounts with
      same/distinct currency.
    - extract amount from backup account.
    - deposit amount from backup amount.
  """
