defmodule Mix.Tasks.Points.Client.Transactions.Exec do
  ...
  defrun fn([token | [name | [params | _]]]) ->
    points(base_url, token) |> transactions(exec: name, params: params)
  end
  ...
  defmodule Transfer do
    ...
    defrun fn([token | [params | _]]) ->
      points(base_url, token) |> transactions(exec: "transfer", params: params)
    end
  end
  defmodule Deposit do
    ...
    defrun fn([token | [params | _]]) ->
      points(base_url, token) |> transactions(exec: "deposit", params: params)
    end
  end
  defmodule Extract do
    ...
    defrun fn([token | [params | _]]) ->
      points(base_url, token) |> transactions(exec: "extract", params: params)
    end
  end
end
